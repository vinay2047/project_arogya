  ...
  return (
    <div className="space-y-8">
               ...
               <div>
                ...
                <div className="border rounded-lg p-4">
                 <Calendar
                  ...
                  classNames={{
                     day_selected: 'bg-teal-600 text-white hover:bg-teal-600 hover:text-white focus:bg-teal-600 foucus:text-white',
                     day_today: 'bg-teal-100 text-teal-900 font-bold',
                          ...
                          return (
                             <Button
                              key={slot}
                               ...
                               disabled={isDisabled}
                               className={`p-3 justify-start ${isDisabled ? 'opacity-50 cursor-not-allowed bg-gray-100 text-gray-400 border-gray-200' : isSelected ? "bg-teal-600 text-white shadow-lg" : "hover:border-teal-200 hover:bg-teal-50"}`}
        ...
        <div className="flex justify-end">
           ...
           className="px-8 py-3 bg-teal-600 hover:bg-teal-700 text-lg font-semibold"
          >
            Continue
          </Button>
        </div>
